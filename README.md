...
Write a Java based web service that navigates an imaginary robotic cleaner (much like a [Roomba](https://en.wikipedia.org/wiki/Roomba)) through an oil spill in the sea.
